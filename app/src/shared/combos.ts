 ...
 *
 * ДҮРМИЙН ТЭМДЭГЛЭЛ: шулуун нь 3-4-...-K-A-2 дарааллаар дараалсан байна
 * (жишээ нь 10-J-Q-K-A, J-Q-K-A-2). Үүнээс гадна A-2-3-4-5 "wheel" хувилбарыг
 * зөвшөөрөх бөгөөд покерын нэгэн адил хамгийн сул шулуунд тооцно.
 */
