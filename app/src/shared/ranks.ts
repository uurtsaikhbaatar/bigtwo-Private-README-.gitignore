...
export const RANKS: readonly Rank[] = [
  { wins: 0, name: 'Байлдагч', badge: '▎', group: 'Байлдагч' },
  { wins: 1, name: 'Ахлах байлдагч', badge: '▎▎', group: 'Байлдагч' },
  { wins: 3, name: 'Дэд түрүүч', badge: '▎▎▎', group: 'Байлдагч' },
  { wins: 5, name: 'Түрүүч', badge: '❯', group: 'Байлдагч' },
  { wins: 8, name: 'Ахлах түрүүч', badge: '❯❯', group: 'Байлдагч' },

  { wins: 12, name: 'Дэд ахлагч', badge: '❯❯❯', group: 'Ахлагч' },
  { wins: 16, name: 'Ахлагч', badge: '◆', group: 'Ахлагч' },
  { wins: 21, name: 'Ахлах ахлагч', badge: '◆◆', group: 'Ахлагч' },
  { wins: 27, name: 'Сургагч ахлагч', badge: '◆◆◆', group: 'Ахлагч' },
  { wins: 34, name: 'Тэргүүн ахлагч', badge: '◈', group: 'Ахлагч' },

  { wins: 42, name: 'Дэслэгч', badge: '★', group: 'Офицер' },
  { wins: 50, name: 'Ахлах дэслэгч', badge: '★★', group: 'Офицер' },
  { wins: 60, name: 'Ахмад', badge: '★★★', group: 'Офицер' },
  { wins: 75, name: 'Хошууч', badge: '✦', group: 'Офицер' },
  { wins: 95, name: 'Дэд хурандаа', badge: '✦✦', group: 'Офицер' },
  { wins: 115, name: 'Хурандаа', badge: '✦✦✦', group: 'Офицер' },

  { wins: 140, name: 'Бригадын генерал', badge: '🎖', group: 'Генерал' },
  { wins: 170, name: 'Хошууч генерал', badge: '🎖🎖', group: 'Генерал' },
  { wins: 205, name: 'Дэслэгч генерал', badge: '🎖🎖🎖', group: 'Генерал' },
  { wins: 245, name: 'Генерал', badge: '👑', group: 'Генерал' },
] as const;
