...
export interface Room {
  ...
  /**
   * Тойрог дуусаад (roundEnd) автоматаар дараагийн тойрог хэзээ эхлэх вэ (epoch
   * ms). Эзний "next"-ээс хамаарч гацахгүй болгоно — эзэн алга/тасарсан ч
   * тоглоом үргэлжилнэ. Тойрог эхлэх бүрд null болгож цэвэрлэнэ. Түр төлөв тул
