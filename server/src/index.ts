 ...
 *
 * Үндэсний статистикийн хорооны "хамгийн түгээмэл нэр" жагсаалтаас сонгосон
 * (1212.mn). Түвшний дагавар нэмэгддэг тул богинохоныг нь авав.
 */
const BOT_NAMES = [
  'Хулан', // 13 893
  'Мишээл', // 14 109
...
function seat(socket: WebSocket, room: Room, name: string): void {
  ...
  if (prior) {
    ...
    if (priorSeat) {
      ...
      // Өөр өрөөнд байсан. Хэрэв хуучин өрөө нь ИДЭВХТЭЙ ТОГЛОЛТ дунд бол
      // суудлыг НЬ ЧӨЛӨӨЛӨХГҮЙ — эс бөгөөс хуудас дахин ачаалах, reconnect
      // дараалал зэргээс болж санамсаргүй join явахад тоглогчийг тоглолтоос нь
      // хөөж, "систем өөрөө гаргалаа" болдог (найз хожиж яваад гэнэт гардаг байв).
      // Оронд нь join-ыг татгалзана — тоглогч тоглолтдоо үлдэнэ. Гарахыг хүсвэл
      // "Гарах" товч ('leave') ашиглана.
      const pp = prior.room.state.phase;
      if (pp === 'playing' || pp === 'drawing' || pp === 'roundEnd') {
        throw new RuleError(
          'Та тоглолтын дунд байна. Өөр өрөөнд орохын тулд эхлээд "Гарах" дарж гараарай.',
        );
      }
      // Лобби/matchEnd — гарахад аюулгүй.
